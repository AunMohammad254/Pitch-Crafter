...
export default function Auth() {
  ...
  return (
    <div className="min-h-screen main-content flex items-center justify-center p-3 sm:p-4 lg:p-6">
      <div className="w-full max-w-sm sm:max-w-md animate-fade-in-up">
        ...
        {/* Auth Card */}
        <div className="card-glass p-6 sm:p-8 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          ...
          <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="btn-primary w-full group py-3 sm:py-4 text-base sm:text-lg"
            >
              {loading ? (
          ...
          <div className="mt-6 sm:mt-8 text-center">
            <button
              ...
              className="text-primary-600 hover:text-primary-700 font-semibold transition-colors duration-200 hover:underline text-sm sm:text-base px-2"
            >
          ...
          {message && (
            <div className={`mt-4 sm:mt-6 p-3 sm:p-4 rounded-xl text-xs sm:text-sm font-medium animate-fade-in-up ${
        ...
        {/* Features Preview */}
        <div className="mt-8 sm:mt-12 grid grid-cols-3 gap-2 sm:gap-4 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
